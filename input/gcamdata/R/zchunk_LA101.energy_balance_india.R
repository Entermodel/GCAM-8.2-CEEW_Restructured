...
module_gcamindia_LA101.energy_balance <- function(command, ...) {
   ...
   MODULE_INPUTS <-
    c(FILE = "gcam-india/A10.EB_FuelMap",
  ...
  MODULE_OUTPUTS <-
    c("L101.india_state_A10.EB_SecFuel_mtoe",
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    L101.india_state_EB_EJ_state_S_F <- bind_rows (A10.EB_bld_SecFuel_EJ, L101.india_state_EB_EJ_state_S_F)

    L101.india_state_EB_EJ_state_S_F <- L101.india_state_EB_EJ_state_S_F %>% select(-year,-value)
