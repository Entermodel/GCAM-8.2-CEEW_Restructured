...
module_india_L254.transportation <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c(FILE = "gcam-india/UCD_techs_india",
             ...
             FILE = "gcam-india/A54.globaltech_passthru",
             FILE = "gcam-india/A54.sector",
    ...
    A54.globaltech_passthru <- get_data(all_data, "gcam-india/A54.globaltech_passthru")
    A54.sector <- get_data(all_data, "gcam-india/A54.sector")
    ...
    L254.GlobalTechShrwt_passthru_India %>%
      ...
      add_precursors("gcam-india/A54.globaltech_passthru") ->
      L254.GlobalTechShrwt_passthru_India
    ...
    L254.BaseService_trn_India %>%
      ...
      add_precursors("gcam-india/A54.sector") ->
      L254.BaseService_trn_India

    return_data(L254.DeleteSupplysector_Indiatrn,
                L254.DeleteFinalDemand_Indiatrn,
                L254.Supplysector_trn_India,
                L254.FinalEnergyKeyword_trn_India,
                L254.tranSubsectorLogit_India,
